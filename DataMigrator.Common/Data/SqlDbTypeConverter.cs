...
{
    private static readonly List<(FieldType FieldType, SqlDbType SqlDbType)> fieldTypes = new();
    private static readonly List<(SqlDbType SqlDbType, FieldType FieldType)> sqlDbTypes = new();
    ...
    public FieldType GetDataMigratorFieldType(SqlDbType providerFieldType) => sqlDbTypes.First(x => x.SqlDbType == providerFieldType).FieldType;

    public SqlDbType GetDataProviderFieldType(FieldType fieldType) => fieldTypes.First(x => x.FieldType == fieldType).SqlDbType;
