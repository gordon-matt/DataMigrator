...
{
    private static readonly List<(FieldType FieldType, SPFieldType SPFieldType)> fieldTypes = new();
    private static readonly List<(SPFieldType SPFieldType, FieldType FieldType)> providerFieldTypes = new();
    ...
    public FieldType GetDataMigratorFieldType(SPFieldType providerFieldType) =>
        providerFieldTypes.First(x => x.SPFieldType == providerFieldType).FieldType;

    public SPFieldType GetDataProviderFieldType(FieldType fieldType) =>
        fieldTypes.First(x => x.FieldType == fieldType).SPFieldType;
